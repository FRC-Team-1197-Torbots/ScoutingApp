...
public class MatchInfo : MonoBehaviour
{
  ...
  //AUTO
       //controller 1     
            ...
            else if(Input.GetAxis("Xbox_1_DH") > 0)
            {
                buttonPressed = true;
   ...
   //controller 2
           ...
           if (Input.GetButtonUp("Xbox_2_B"))
            ...
            else if (Input.GetAxis("Xbox_2_DH") > 0)
            {
                buttonPressed2 = true;
   ...
   //controller 3
           ...
           if (Input.GetButtonUp("Xbox_3_B"))
            ...
            else if (Input.GetAxis("Xbox_3_DH") > 0)
            {
                buttonPressed3 = true;
    ...
    // controller 4
            ...
            else if (Input.GetAxis("Xbox_4_DH") > 0)
            {
                buttonPressed4 = true;
    ...
    //controller 5
            ...
            else if (Input.GetAxis("Xbox_5_DH") > 0)
            {
                buttonPressed5 = true;
    ...
    //controller 6
            ...
            else if (Input.GetAxis("Xbox_6_DH") > 0)
            {
                buttonPressed6 = true;
